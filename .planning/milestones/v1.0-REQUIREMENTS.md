...
**Archived:** 2026-03-17
**Status:** ✅ SHIPPED
**Note:** RCHG-01..05 and PLAY-01..06 checkboxes updated 2026-03-17 to reflect shipped status.
...
- [x] **RCHG-01**: Player can submit a roster change request
- [x] **RCHG-02**: Faction Commander can view all pending roster change requests for an event
- [x] **RCHG-03**: Faction Commander can approve or deny a roster change request
- [x] **RCHG-04**: Player receives an email notification when their request is approved or denied
- [x] **RCHG-05**: Roster is updated automatically when a change request is approved

### Player Experience

- [x] **PLAY-01**: Player can view their squad and platoon assignment for an event
- [x] **PLAY-02**: Player can view the full faction roster (names, callsigns, team affiliation, assignments)
- [x] **PLAY-03**: Player can access all published event information sections
- [x] **PLAY-04**: Player can download maps and documents from an event
- [x] **PLAY-05**: Player-facing UI is fully functional on mobile phones (responsive, 44px touch targets)
- [x] **PLAY-06**: Callsign is displayed prominently in all roster views
...
| RCHG-01 | Phase 4 | Complete |
| RCHG-02 | Phase 4 | Complete |
| RCHG-03 | Phase 4 | Complete |
| RCHG-04 | Phase 4 | Complete |
| RCHG-05 | Phase 4 | Complete |
